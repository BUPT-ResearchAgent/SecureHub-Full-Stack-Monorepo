...
export const ENDPOINT_AUDIT: EndpointAudit[] = [
  ...
  },
  {
    ...
    lastVerified: '2026-06-14',
    knownIssues: ['后端尚未实现；前端学习路径 DAG 暂全靠 mock'],
  },
  {
    ...
    lastVerified: '2026-06-14',
    knownIssues: [
      '后端缺 RAG + LLM 编排链，前端直接 mock SSE',
      '前端通过 isMockMode() 守门，未走 withMockFallback',
    ],
    sse: true,
  },
  {
  ...
  },
  {
    ...
    lastVerified: '2026-06-14',
    knownIssues: ['前端通过 isMockMode() 守门'],
    sse: true,
  },
  {
    id: 'profile-me',
  ...
  },
  {
    ...
    lastVerified: '2026-06-14',
    knownIssues: ['后端尚未接 outcome_evaluator；前端 mock 直接返回 score + 雷达更新'],
  },
];
